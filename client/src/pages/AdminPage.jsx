...
const ROLE_LABELS = { admin: 'מנהל מערכת', manager: 'מנהל', sales_manager: 'מנהל מכירות', sales: 'מכירות', production: 'הפקה', suppliers: 'ספקים', rsvp: 'אישורי הגעה', operations: 'תפעול', finance: 'כספים' };
const ALL_PERMISSIONS = ['admin','manager','sales_manager','sales','production','suppliers','rsvp','operations','finance'];
