            ...
            <table className="w-full text-xs min-w-[900px]">
              <thead>
                <tr className="bg-violet-50/60 text-xs font-bold text-slate-500 uppercase tracking-wide border-b border-violet-100">
                  <th className="px-2 py-3 text-right sticky right-0 z-10 bg-violet-50 [will-change:transform]">#</th>
                  <th className="px-2 py-3 text-right sticky right-8 z-10 bg-violet-50 shadow-[-4px_0_6px_-2px_rgba(0,0,0,0.06)] [will-change:transform]">שם האירוע</th>
              ...
              <tbody className="divide-y divide-violet-50">
                {sortedLeads.map((lead, idx) => (
                  ...
                  >
                    <td className="px-2 py-3 text-slate-400 font-medium sticky right-0 z-10 bg-white [will-change:transform]">{idx + 1}</td>
                    <td className="px-2 py-3 font-semibold text-slate-800 sticky right-8 z-10 bg-white shadow-[-4px_0_6px_-2px_rgba(0,0,0,0.06)] [will-change:transform]">
