...
<h2>${t('title') || '&#x05D4;&#x05E1;&#x05DB;&#x05DD; &#x05D4;&#x05D6;&#x05DE;&#x05E0;&#x05EA; &#x05D0;&#x05D9;&#x05E8;&#x05D5;&#x05E2;'}</h2>
...
<p>${t('depositLine')} <strong>${fmt(depositAmount)} ${shkalHtml} (${esc(String(depositPercent))}%)</strong> ${t('depositSuffix')} <strong>${fmt(depositAmountVat)} ${shkalHtml}</strong></p>
<p>${t('remainderLine')} <strong>${fmt(remainingBalance)} ${shkalHtml} ${t('remainderSuffix')}</strong></p>
<p>${t('checkNote')}</p>
<p>${t('paymentNote')}</p>
